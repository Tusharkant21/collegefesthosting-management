...
$query = "SELECT * FROM registration_form where find_in_set('Rangoli',cultural) ORDER BY slno";
...
if($total !=0)
{
    ...
    <h2 align="center"><mark>List  Of Participants(Rangoli)</mark></h2>
<center><table border="2" cellspacing="3" width="90%">
    <tr>
   <th width="1%">Entry No</th>     
   <th width="11%">Name</th>
   <th width="6%">Registration No</th>
   <th width="8%">Student Of</th>
