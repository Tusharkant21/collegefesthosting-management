...
$query = "SELECT * FROM registration_form where find_in_set('hundred',race) AND gender='female' ORDER BY slno";
...
if($total !=0)
{
    ...
    <h2 align="center"><mark>List  Of Participants(Race 100m female)</mark></h2>
